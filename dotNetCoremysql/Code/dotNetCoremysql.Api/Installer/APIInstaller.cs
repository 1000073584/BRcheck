...
dotNetCoremysql.Api.Filters;
using dotNetCoremysql.Business.Installer;
using System;
using OpenTelemetry.Exporter;
using OpenTelemetry.Exporter.OpenTelemetryProtocol;
using OpenTelemetry.Logs;
...
namespace dotNetCoremysql.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotNetCoremysql API", Version = version + "-" + branch });
        });
