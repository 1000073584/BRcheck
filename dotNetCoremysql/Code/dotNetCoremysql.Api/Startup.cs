using dotNetCoremysql.Api.Installer;
using dotNetCoremysql.Api.Middleware;
using dotNetCoremysql.Data.Repositories;
...
using System;
using dotNetCoremysql.Api.Opentelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;
namespace dotNetCoremysql.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "dotNetCoremysql V1");
        });
