...
using MongoDB.Api.Filters;
using MongoDB.BusinessServices.Installer;
using System;
using OpenTelemetry.Exporter;
using OpenTelemetry.Exporter.OpenTelemetryProtocol;
using OpenTelemetry.Logs;
using Microsoft.Extensions.Logging;
namespace MongoDB.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MongoDB API", Version = version + "-" + branch});
            });
